...
class _HomeApiService implements HomeApiService {
  ...
  @override
  Future<BannerModel> getBanners(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<BannerModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late BannerModel _value;
    try {
      _value = BannerModel.fromJson(_result.data!);
    } on Object catch (e, s) {
