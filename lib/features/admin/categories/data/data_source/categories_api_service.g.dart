...
class _CategoriesApiService implements CategoriesApiService {
  ...
  Future<AddCategoryResponceModel> addCategory(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<AddCategoryResponceModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<DeleteCategoryResponceModel> deleteCategory(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<DeleteCategoryResponceModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<UpdateCategoryResponceModel> updateCategory(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _options = _setStreamType<UpdateCategoryResponceModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateCategoryResponceModel _value;
    try {
      _value = UpdateCategoryResponceModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
